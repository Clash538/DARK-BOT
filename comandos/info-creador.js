...
//------------ BIO
let teksbio = `
*—◉ 𝙴𝙻 𝙽𝚄𝙼𝙴𝚁𝙾 𝙳𝙴 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁 𝙴𝚂 wa.me/584129763459
*—◉ 𝙴𝙻 𝙽𝚄𝙼𝙴𝚁𝙾 𝙳𝙴𝙻 𝙲𝙾𝙻𝙰𝙱𝙾𝚁𝙰𝙳𝙾𝚁 𝟷 𝙴𝚂 wa.me/4121127840*

───────[ INFORMACIÓN DEL BOT ]───────

✅ *NOMBRE: ༒𝕯𐊅ℜ𝖐-𝕭𝖔𝖙⍉ꤲ*
🥏 *Whatsapp* wa.me/584129763459
      ...
      const count = args[1] && args[1].length > 0 ? Math.min(99999999, Math.max(parseInt(args[1]), 1)) : !args[1] || args.length < 3 ? 1 : Math.min(1, count)
        switch (type) {
          ...
          conn.reply(m.chat, wm, m, { contextInfo: { mentionedJid: [nowner] }})
            break
            case 'bio':
          conn.sendHydrated(m.chat, teksbio, wm, pp, "https://wa.me/584129763459 💬 ᴄʜᴀᴛs", null,null, [["BY CARLOS-OFC", null], [null, null],[null,null]], m)
            break
